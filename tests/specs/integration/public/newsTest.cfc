...
component extends="coldbox.system.testing.BaseTestCase" appMapping="/"{
	...
	function run(){
		...
		describe( "//public/news Suite", function(){
			...
			it( "recent", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "public.news.recent" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
			...
			it( "removed", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "public.news.removed" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
			...
			it( "remove", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "public.news.remove" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
			...
			it( "view", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "public.news.view" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
